 ...
 * @LastEditors: windyGu
 * @LastEditTime: 2022-05-05 00:36:44
 * @FilePath: \nb_blog_web\src\App.vue
 * @Description: 
-->
<template>
  <div id="app">
      ...
      <el-row justify="center">
        ...
        <el-col :span="20">
          ...
          <ul class="tablist">
            ...
            <li class="tab">会员</li>
            <li class="tab">发现</li>
            <li class="tab">等你来答</li>
          </ul>
          <div class="searchBar">
            <el-input class="tab" placeholder="请输入内容"></el-input>
            <el-button class="tab" size="mini" type="primary">搜索</el-button>
          </div>
          <div class="appHeader-userinfo">
            <el-button
              type="text"
              class="button-userinfo el-icon-chat-dot-round"
            ></el-button>
            <el-button
              type="text"
              class="button-userinfo el-icon-message-solid"
            ></el-button>
            <el-avatar
              shape="square"
              size="medium "
